...
class RebloggedPost(private val driver: WebDriver): Post(driver){
    ...
    @FindBy(xpath="//*[contains(@class,'is_mine')]/div/div[4]/div[2]/div/div[2]")
    override var replyBtn: WebElement? = null

    @FindBy(xpath="//*[contains(@class,'is_mine')]/div/div[4]/div[2]/div/a")
    override var reblogBtn: WebElement? = null

    @FindBy(xpath = "//*[contains(@class,'is_mine')]/div/div[4]/div[2]/div/div[3]")
